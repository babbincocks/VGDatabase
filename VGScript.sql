...
('Khajiit', 7, NULL, 1, 1, 'One of the beast races of Tamriel, Khajiit hail from the province of Elsweyr. Khajiit are feline in appearance, which varies not from their ancestry, but from what phase the moon is currently in. Khajiit typically refer to themselves in the third person, and are not typically trusted by other races. This stems from their innate ability to remain unseen and unheard, making them some of the best thieves, but in no way are a majority of Khajiits thieves.'), 
...
('Argonian', 7, NULL, 1, 1, 'One of the beast races of Tamriel, Argonians hail from the province of Black Marsh. Argonians are reptilian in appearance, possessing a coat of scales and lizard-like eyes. Argonians also '), 
