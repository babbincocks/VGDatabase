...
('Bosmer', 7, NULL, 1, 1, 'Commonly referred to as Wood Elves, the Bosmer are a race of Mer (Elves) that hail from the province of Valenwood. As their colloquial name implies, Bosmer aren''t the most technologically advanced race in Tamriel; rather, they''ve set their civilization in the wilderness, with their major cities being located in giant, walking trees. Bosmer are one of the smallest races of Tamriel, '), 
